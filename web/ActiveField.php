...
class ActiveField extends \yii\widgets\ActiveField
{
	 ...
	 * {@inheritdoc}
	 */
	public $options = ['class' => ['widget' => 'layui-form-item']];
	/**
	 * {@inheritdoc}
	 */
	public $inputOptions = ['class' => ['widget' => 'layui-input']];
	...
	public function checkbox($options = [], $enclosedByLabel = false)
	{
		...
		Html::removeCssClass($options, 'layui-input');
	...
	public function dropdownList($items, $options = [])
	{
		...
		$this->parts['{input}'] = Html::selectList($this->model, $this->attribute, $items, $options);
	...
	{
		Html::addCssClass($options, ['widget' => 'layui-input-file']);
