...
class Html extends \yii\helpers\Html
{
	...
	public static function selectList($model, $attribute, $items, $options = [])
	{
		$ddl= static::activeListInput('dropDownList', $model, $attribute, $items, $options);
		
		//$input=
		
		
		//parent::dropDownList($name)
