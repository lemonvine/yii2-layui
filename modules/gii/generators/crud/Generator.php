 ...
 * @since 2.0
 */
class Generator extends \backend\gii\Generator
{
	public $modelClass;
	...
	public function generateActiveSearchField($attribute)
	{
		...
		if ($tableSchema === false) {
			return "\$form->field(\$searchModel, '$attribute')";
		}

		$column = $tableSchema->columns[$attribute];
		if ($column->phpType === 'boolean') {
			return "\$form->field(\$searchModel, '$attribute')->checkbox()";
		}
