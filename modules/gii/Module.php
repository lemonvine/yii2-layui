...
class Module extends \yii\base\Module implements BootstrapInterface
{
	 ...
	 * {@inheritdoc}
	 */
	public $controllerNamespace = 'backend\gii\controllers';
	/**
	...
	public function bootstrap($app)
	{
		if ($app instanceof \yii\web\Application) {
			...
			$app->controllerMap[$this->id] = [
				'class' => 'backend\gii\console\GenerateController',
	...
	{
		return [
			'model' => ['class' => 'backend\gii\generators\model\Generator'],
			'crud' => ['class' => 'backend\gii\generators\crud\Generator'],
			'controller' => ['class' => 'backend\gii\generators\controller\Generator'],
			'form' => ['class' => 'backend\gii\generators\form\Generator'],
			'module' => ['class' => 'backend\gii\generators\module\Generator'],
			'extension' => ['class' => 'backend\gii\generators\extension\Generator'],
		];
	}
